...
-- dump(bit.band(controlType, CONTROL_TYPE_PENG),"走到着了1")
...
--@显示听牌可选择 --- 明暗牌
-- function ControlPlaneOperator:showTingSelectCards()
-- 	--通知手牌添加明暗效果
-- 	-- ZZMJ_CONTROLLER:showTingSelectCards(ZZMJ_CONTROL_TABLE)
